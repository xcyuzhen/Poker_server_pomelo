var RoomNumMgrService = require('../service/roomNumMgrService');

module.exports = function(app, opts) {
    var cmp = new Component(app, opts);
    app.set('roomNumMgrService', cmp, true);
    return cmp;
};
...
var Component = function(app, opts) {
    opts = opts || {};
    this.app = app;
    this.service = new RoomNumMgrService(app, opts);
